            ...
            <div className="grid lg:grid-cols-12 gap-12">
                <div className="lg:col-span-4">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <h3 className="text-sm font-black text-slate-900 uppercase tracking-tight">Identity Matrix</h3>
                    </div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed">Core parameters defining the organizational node's registry data and visual fingerprint.</p>
                </div>
                ...
                <div className="lg:col-span-8 grid gap-8">
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-2">
                                <Building2 className="w-3.5 h-3.5" /> Organizational Name
                            </Label>
                            <Input
                                value={companyName}
                        ...
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-2">
                                <ShieldCheck className="w-3.5 h-3.5" /> Registry Identifier (Tax ID)
                            </Label>
                            <Input
                                value={taxId}
                                onChange={e => updateConfig({ taxId: e.target.value })}
                                placeholder="TAX_IDENT_ALPHA"
                                className="h-14 bg-slate-50 border-none rounded-2xl px-6 text-[11px] font-black uppercase focus:ring-2 focus:ring-black"
                            />
                        </div>
                        <div className="space-y-3 md:col-span-2">
                            <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-2">
                                <Globe className="w-3.5 h-3.5" /> Digital Nexus (Website URL)
                            </Label>
                            <Input
                                value={websiteUrl}
                                onChange={e => updateConfig({ websiteUrl: e.target.value })}
                                placeholder="HTTPS://NEXUS.DOM"
                                className="h-14 bg-slate-50 border-none rounded-2xl px-6 text-[11px] font-black uppercase focus:ring-2 focus:ring-black"
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Visual Fingerprint (Logo)</Label>
                        <div className="flex items-center gap-8 p-10 bg-slate-50 rounded-[2.5rem] border border-slate-100 group transition-all">
                            <div className="h-32 w-32 rounded-[2rem] border-2 border-dashed border-slate-200 flex flex-col items-center justify-center bg-white group-hover:border-black transition-all relative overflow-hidden">
                                ...
                                <p className="text-[7px] font-black text-slate-300 uppercase tracking-[0.2em] mt-3">Upload Unit</p>
                            </div>
                            <div className="flex flex-col gap-3">
                                <Button variant="ghost" className="h-12 px-8 rounded-2xl bg-white text-slate-400 hover:text-black font-black uppercase text-[9px] tracking-widest shadow-sm border border-slate-100">Synchronize Image</Button>
            ...
            <div className="pt-12 border-t border-slate-100 grid lg:grid-cols-12 gap-12">
                <div className="lg:col-span-4">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <h3 className="text-sm font-black text-slate-900 uppercase tracking-tight">Integration Nexus</h3>
                    </div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed">Communication parameters for external API bridgeheads and AI synthesis nodes.</p>
                </div>

                <div className="lg:col-span-8 grid md:grid-cols-2 gap-8">
                    <div className="space-y-3 md:col-span-2">
                        <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">ETIMS Registry Bridge (API URL)</Label>
                        <Input
                            value={etimsApiUrl}
                            onChange={e => updateConfig({ etimsApiUrl: e.target.value })}
                            placeholder="HTTPS://ETIMS.GATEWAY.UNIT"
                            className="h-14 bg-slate-50 border-none rounded-2xl px-6 text-[11px] font-black uppercase focus:ring-2 focus:ring-black"
                        />
                    </div>
                    <div className="space-y-3 md:col-span-2">
                        <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-2">
                            <Cpu className="w-3.5 h-3.5" /> Intelligence Host Node (AI URL)
                        </Label>
                        <Input
                            value={aiHostUrl}
                            onChange={e => updateConfig({ aiHostUrl: e.target.value })}
                            placeholder="HTTPS://CORE.AI.NEXUS"
                            className="h-14 bg-slate-50 border-none rounded-2xl px-6 text-[11px] font-black uppercase focus:ring-2 focus:ring-black"
                        />
                    </div>
                    <div className="space-y-3">
                        <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Synthesis Identity (Username)</Label>
                        <Input
                    ...
                    <div className="space-y-3">
                        <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-2">
                            <KeyRound className="w-3.5 h-3.5" /> Synthesis Key (Password)
                        </Label>
                        <Input
                            type="password"
            ...
            <div className="pt-12 border-t border-slate-100 grid lg:grid-cols-12 gap-12">
                <div className="lg:col-span-4">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <h3 className="text-sm font-black text-slate-900 uppercase tracking-tight">Mainframe Protocols</h3>
                    </div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed">System-level utilities for data preservation and version synchronization.</p>
                </div>
                ...
                <div className="lg:col-span-8">
                    <div className="flex gap-4">
                        <Button variant="ghost" className="h-16 px-10 rounded-[1.8rem] bg-slate-50 border border-slate-100 text-slate-600 hover:text-black font-black uppercase text-[10px] tracking-widest flex items-center gap-3 transition-all hover:bg-white hover:shadow-xl hover:shadow-slate-200/50">
                            ...
                            Force Database Persistence (Manual Backup)
                        </Button>
                        <Button variant="ghost" className="h-16 px-10 rounded-[1.8rem] bg-slate-50 border border-slate-100 text-slate-600 hover:text-black font-black uppercase text-[10px] tracking-widest flex items-center gap-3 transition-all hover:bg-white hover:shadow-xl hover:shadow-slate-200/50">
                            <RefreshCw className="w-5 h-5 text-emerald-400" />
                            Protocol Integrity Check (Updates)
                        </Button>
                    </div>
                </div>
            </div>
